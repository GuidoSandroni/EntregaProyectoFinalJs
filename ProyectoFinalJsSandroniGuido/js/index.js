...
// Función para obtener las tareas desde el archivo JSON usando fetch
...
// Función para buscar y filtrar tareas usando Lodash
function buscarTarea(termino) {
    const tareasFiltradas = _.filter(tareas, tarea => _.includes(tarea.texto.toLowerCase(), termino.toLowerCase()));
